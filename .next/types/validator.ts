...
// Validate ../../src/app/api/auth/callback/facebook/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/callback/facebook">> = Specific
  const handler = {} as typeof import("../../src/app/api/auth/callback/facebook/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
